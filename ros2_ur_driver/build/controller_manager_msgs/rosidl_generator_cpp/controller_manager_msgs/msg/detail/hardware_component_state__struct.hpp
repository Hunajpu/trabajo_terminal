...
struct HardwareComponentState_
{
  ...
  using _command_interfaces_type =
    std::vector<controller_manager_msgs::msg::HardwareInterface_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::HardwareInterface_<ContainerAllocator>>::other>;
  ...
  Type & set__command_interfaces(
    const std::vector<controller_manager_msgs::msg::HardwareInterface_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::HardwareInterface_<ContainerAllocator>>::other> & _arg)
  {
