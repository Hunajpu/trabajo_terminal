...
#include "rosidl_runtime_c/string.h"  // claimed_interfaces, name, required_command_interfaces, required_state_interfaces, state, type
#include "rosidl_runtime_c/string_functions.h"  // claimed_interfaces, name, required_command_interfaces, required_state_interfaces, state, type
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: claimed_interfaces
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->claimed_interfaces, size)) {
      return "failed to create array for field 'claimed_interfaces'";
    }
    auto array_ptr = ros_message->claimed_interfaces.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: required_command_interfaces
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->required_command_interfaces, size)) {
      return "failed to create array for field 'required_command_interfaces'";
    }
    auto array_ptr = ros_message->required_command_interfaces.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: required_state_interfaces
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->required_state_interfaces, size)) {
      return "failed to create array for field 'required_state_interfaces'";
    }
    auto array_ptr = ros_message->required_state_interfaces.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
{
  return max_serialized_size_controller_manager_msgs__msg__ControllerState(
    full_bounded, 0);
}
