...
static size_t _SetHardwareComponentState_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__SetHardwareComponentState_Request(
    full_bounded, 0);
}
...
static size_t _SetHardwareComponentState_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__SetHardwareComponentState_Response(
    full_bounded, 0);
}
