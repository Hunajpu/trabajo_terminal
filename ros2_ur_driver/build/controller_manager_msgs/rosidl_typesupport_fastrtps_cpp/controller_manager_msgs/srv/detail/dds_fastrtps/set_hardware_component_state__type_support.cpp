...
{
  return max_serialized_size_SetHardwareComponentState_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_SetHardwareComponentState_Response(full_bounded, 0);
}
