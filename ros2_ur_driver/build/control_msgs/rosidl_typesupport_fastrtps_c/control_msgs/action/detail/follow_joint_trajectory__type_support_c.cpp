  ...
  void * untyped_ros_message)
{
  ...
  // Field name: component_path_tolerance
  {
    ...
    if (!control_msgs__msg__JointComponentTolerance__Sequence__init(&ros_message->component_path_tolerance, size)) {
      return "failed to create array for field 'component_path_tolerance'";
    }
    auto array_ptr = ros_message->component_path_tolerance.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: component_goal_tolerance
  {
    ...
    if (!control_msgs__msg__JointComponentTolerance__Sequence__init(&ros_message->component_goal_tolerance, size)) {
      return "failed to create array for field 'component_goal_tolerance'";
    }
    auto array_ptr = ros_message->component_goal_tolerance.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__FollowJointTrajectory_FeedbackMessage(
    full_bounded, 0);
}
