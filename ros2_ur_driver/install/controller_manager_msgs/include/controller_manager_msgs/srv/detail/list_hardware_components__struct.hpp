...
struct ListHardwareComponents_Response_
{
  ...
  using _component_type =
    std::vector<controller_manager_msgs::msg::HardwareComponentState_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::HardwareComponentState_<ContainerAllocator>>::other>;
  _component_type component;

  // setters for named parameter idiom
  Type & set__component(
    const std::vector<controller_manager_msgs::msg::HardwareComponentState_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::HardwareComponentState_<ContainerAllocator>>::other> & _arg)
  {
    this->component = _arg;
    return *this;
  }
