...
struct FollowJointTrajectory_Goal_
{
  ...
  using _component_path_tolerance_type =
    std::vector<control_msgs::msg::JointComponentTolerance_<ContainerAllocator>, typename ContainerAllocator::template rebind<control_msgs::msg::JointComponentTolerance_<ContainerAllocator>>::other>;
  ...
  Type & set__component_path_tolerance(
    const std::vector<control_msgs::msg::JointComponentTolerance_<ContainerAllocator>, typename ContainerAllocator::template rebind<control_msgs::msg::JointComponentTolerance_<ContainerAllocator>>::other> & _arg)
  {
